...
export default function UserDashboard({ currentUser, onNavigate }) {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-slate-50 text-slate-900 font-sans p-6 md:p-8 space-y-6">
      {/* Top Welcome Banner */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-200">
        <div>
          <div className="flex items-center space-x-2 mb-2">
            <span className="px-2.5 py-0.5 rounded-md bg-blue-100 text-[#1982bf] text-xs font-bold uppercase tracking-wider">
              User Workstation
            </span>
        ...
        <div className="flex items-center space-x-3 self-start md:self-auto">
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-[#1982bf] hover:bg-[#156ea3] text-white font-semibold text-xs flex items-center space-x-2 shadow-md transition-all cursor-pointer"
          >
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Total Scans</div>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Normal Cases</div>
            <div className="text-2xl font-bold text-emerald-600 mt-1">{normalCount}</div>
            <div className="text-[10px] text-emerald-700 mt-0.5">Unremarkable anatomy</div>
          </div>
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Abnormal Triaged</div>
            <div className="text-2xl font-bold text-rose-600 mt-1">{abnormalCount}</div>
            <div className="text-[10px] text-rose-700 mt-0.5">Flagged for review</div>
          </div>
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">ViT Speed</div>
            <div className="text-2xl font-bold text-[#1982bf] mt-1 font-mono">1.2s</div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Clock className="w-4 h-4 text-[#1982bf]" />
            ...
            <table className="w-full text-left border-collapse text-sm">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-xs font-semibold text-slate-600 uppercase tracking-wider">
                  ...
                  <th className="py-3 px-4">Primary Finding</th>
                      ...
                      <tr key={scan.scan_id || idx} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="py-3 px-4 text-right">
                          <button
                            ...
                            className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-[#1982bf] hover:bg-[#156ea3] text-white text-[11px] font-semibold shadow-sm transition-all cursor-pointer"
                          >
