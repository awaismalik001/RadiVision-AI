      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-200 pb-4">
        <div>
          <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-blue-800 text-[11px] font-semibold mb-1">
            ...
            <span>Vision Transformer (ViT-B/16) • Gemini 3.8 Flash Cross-Verification</span>
          </div>
            ...
            >
              {analyzing ? (
                <>
                  ...
                  <span>Executing Vision Transformer & Gemini 3.8 Flash Verification...</span>
                </>
              ) : (
                <>
            ...
            {analysisResult && (
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                <div className="text-xs text-slate-500 font-mono flex items-center space-x-1.5">
                  ...
                  <span>Scan ID: #{analysisResult.scan_id} • Analyzed: {analysisResult.timestamp}</span>
                </div>
                <button
                  ...
                  <div>
                    ...
                    {analysisResult.timestamp && (
                      <div className="flex items-center space-x-1.5 text-xs text-slate-500 font-mono mt-1">
                        <Clock className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                        <span>Analysis Timestamp: {analysisResult.timestamp}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-blue-50/70 border border-blue-200 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2 text-blue-900 font-semibold text-xs uppercase tracking-wider">
                      ...
                      <span>Gemini 3.8 Flash Multimodal Cross-Verification</span>
                    </div>
                    <div className="flex items-center space-x-1.5">
                      <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-blue-100 text-blue-900 font-bold border border-blue-200">
                        {analysisResult.gemini_refinement.model_version || "Gemini 3.8 Flash"}
                      </span>
